...
VALID_ROLES = frozenset({ADMIN, DIRECTOR, HR_ADMIN, IT_ADMIN, USER})
...
BUSINESS_ADMIN_ROLES = frozenset({ADMIN, DIRECTOR, IT_ADMIN})
...
PERSONAL_PORTAL_ROLES = frozenset({ADMIN, DIRECTOR, HR_ADMIN, USER, IT_ADMIN})
ATTENDANCE_MANAGER_ROLES = frozenset({ADMIN, DIRECTOR, HR_ADMIN, IT_ADMIN})
HR_MANAGER_ROLES = frozenset({ADMIN, DIRECTOR, HR_ADMIN, IT_ADMIN})
